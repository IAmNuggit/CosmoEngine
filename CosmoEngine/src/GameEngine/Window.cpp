...
///Brief desc.
///
///This function initializes the GLFW library. Before GLFW functions can be used, GLFW must be initialised.
///@note This function contains multiple error checking methods
int Window::Initialise()
{
	...
	// Create the window
	mainWindow = glfwCreateWindow(width, height, "Cosmo Engine", NULL, NULL);
	if (!mainWindow)
	{
...
///Brief desc.
///
///This function handles user input in terms of keyboard presses 
